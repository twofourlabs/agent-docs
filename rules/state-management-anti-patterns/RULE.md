...
- [ ] No direct mutations of arrays or objects
- [ ] Store access uses proper hooks in React components
- [ ] Actions use get() parameter, not getState()
- [ ] No getState() calls outside store actions
