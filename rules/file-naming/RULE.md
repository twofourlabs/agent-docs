...
- [ ] Does the file name match the correct case convention?
- [ ] Does the file name match its content (component name, hook name, etc.)?
- [ ] Am I using the correct extension (`.ts` vs `.tsx`)?
- [ ] For platform-specific files, am I using dot notation (`.ios.tsx`)?
- [ ] For barrel exports, am I using `index.ts`?
- [ ] For tests, does the name match the source file?
- [ ] Have I avoided redundant suffixes/prefixes?
