...
export async function listCommand(source, options) {
    ...
    try {
        ...
        if (showAll || options.skills) {
            ...
            if (skills.length > 0) {
                const lines = skills.map(s => `  ${chalk.cyan(s.id)} ${chalk.dim('-')} ${s.description || chalk.dim('No description')}`);
        ...
        if (showAll || options.rules) {
            ...
            if (rules.length > 0) {
                const lines = rules.map(r => `  ${chalk.cyan(r.id)} ${chalk.dim('-')} ${r.description || chalk.dim('No description')}`);
        ...
        if (showAll || options.commands) {
            ...
            if (commands.length > 0) {
                const lines = commands.map(c => `  ${chalk.cyan(c.id)} ${chalk.dim('-')} ${c.description || chalk.dim('No description')}`);
        ...
        if (showAll || options.agents) {
            ...
            if (agents.length > 0) {
                const lines = agents.map(a => `  ${chalk.cyan(a.id)} ${chalk.dim('-')} ${a.description || chalk.dim('No description')}`);
